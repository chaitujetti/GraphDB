...
import ztree.*;
import iterator.*;
import ztree.ConstructPageException;
import ztree.IndexFileScan;
import ztree.IteratorException;
import ztree.KeyClass;
import ztree.KeyNotMatchException;
import ztree.PinPageException;
import ztree.UnpinPageException;
...
public class ZIndexUtils {
   ...
   */
  public static IndexFileScan BTree_scan(CondExpr[] selects, ZIndexFile indFile)
    throws IOException, 
...
//	  */
       ...
       throws UnknownKeyTypeException
  {
    ...
    switch (type.attrType) {
    case AttrType.attrDesc:
      if (choice == 1) return new DescriptorKey(cd.operand1.descriptor);
