...
public class Sort extends Iterator implements GlobalConst
{
  ...
  private void MIN_VAL(Tuple lastElem, AttrType sortFldType) 
    ...
    case AttrType.attrDesc:
      Descriptor minDesc = new Descriptor();
      minDesc.set((short)0, (short)0, (short)0, (short)0, (short)0);
  ...
  private void MAX_VAL(Tuple lastElem, AttrType sortFldType) 
    ...
    case AttrType.attrString:
      ...
      break;
    case AttrType.attrDesc:
      Descriptor maxDesc = new Descriptor();
      maxDesc.set((short)10000, (short)10000, (short)10000, (short)10000, (short)10000);
