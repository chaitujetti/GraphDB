 ...
 */
  ...
  public static Descriptor getDescValue (int position, byte []data)
    throws java.io.IOException
    {
      ...
      /* creates a new data input stream to read data from the
       * specified input stream. Split it into 5 sub streams and
       * read the data to the sub streams.
       */
        ...
        throws java.io.IOException
 {
   ...
   * @param   data    a byte array
   * @param descriptor     the descriptor to be copied into data[]
   * @param position    the position of tht value in data[]
   * @exception   java.io.IOException I/O errors
   */
  public static void setDescValue (Descriptor value, int position, byte []data) 
    throws java.io.IOException
    {
      ...
      for(int i = 0; i < 5; i++){
        ...
        // copies the first 2 bytes of this byte array into data[] 
        System.arraycopy (B, 0, data, position + (i * 2), 2);
      }
    }
}
